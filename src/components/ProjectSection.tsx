...
import { Droplets, Shield, Smartphone, Users, Award, Presentation } from "lucide-react"
              ...
              <div>
                ...
                <div className="text-center flex gap-4 justify-center flex-wrap">
                  <Button
                    ...
                    onClick={() =>
                      window.open(
                        "https://docs.google.com/presentation/d/e/2PACX-1vTOeujUl4T5fYb5kmVTmCgSiXq3wJwK-s-xjIG5Vp-GP1RJZLBA7i_H1SqTQex1uA/pub?start=false&loop=false&delayms=3000",
                        "_blank",
                      )
                    }
                  >
